...
const Page = () => {
  ...
  const fullWorkArray: FULLWORK[] = [
    ...
    },
    {
      ...
      description:
        " These are some of the best running Instagram posts ideated by me. The nature of these posts vary from promotional, creative to purely engagement centric.",
      longdescription:
        " These are some of the best running Instagram posts ideated by me. The nature of these posts vary from promotional, creative to purely engagement centric.",
      poster: gfgInsta,
      ...
      <div className={styles.otherworkbar}>
        {fullWorkArray.map((item, index) => (
          <Link
            ...
            href={item.routeto}
            className={
              item.routeto == pathname
                ? styles.otherworkbaritemActive
                : styles.otherworkbaritem
            }
          >
            {item.heading}
          </Link>
