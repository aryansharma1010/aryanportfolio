...
export default function Home() {
  ...
  const fullWorkArray: FULLWORK[] = [
    ...
    },
    {
      ...
      description: "Geeks For Geeks regularly shares informative and engaging content on their Instagram profile, catering to the tech-savvy community's interests and needs.",
  ...
  const ButtonGroup = ({ next, previous, goToSlide, ...rest }: any) => {
    ...
    return (
      <div className={styles.btngroup}>
        ...
        onClick={() => next()}><BiChevronRight /></button>
      </div>
  ...
  return (
    <div className={styles.workpage}>
      <div className={styles.textBox}>
        <h1>My Projects</h1>
        <p>I have curated a diverse portfolio of branding and product advertisements, showcasing my expertise in crafting engaging content across various platforms. From captivating gaming nostalgia to motion graphic ads, my work has garnered attention and success, driving high click-through rates and engagement.</p>
      </div>
            ...
            fullWorkArray.map((item, index) => (
              <div className={styles.workcard} key={index}>
                ...
                <div className={styles.workcardtext}>
                  ...
                  <Link href={item.routeto}>View</Link>
                </div>
              </div>
